    ...
    public function check($photo = null)
    {
        try {
            ...
            if ($this->width <= 320 && $this->height <= 320) {
                ...
                imagecopyresized($im, $this->images, $this->x, $this->y, 0, 0, $this->newWidth, $this->newHeight,
                ...
                imagecopyresized($im, $this->images, $this->x, 0, 0, 0, $this->newWidth, 1349, $this->width,
                    $this->height);
            } elseif ($this->height > $this->width && $this->height <= 1100) {
                $this->newHeight = round((640 / $this->width) * $this->height);
                ...
                imagecopyresized($im, $this->images, $this->x, 0, 0, 0, $this->newWidth, 799, $this->width,
                    $this->height);
            }
            $uniqID = uniqid();
            $path = "/home/feedPhotoTmp/$uniqID.jpg";
